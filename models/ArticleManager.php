 ...
 * @param array $orderBy : tableau associatif ['colonne' => 'ASC|DESC']
 * @return array : un tableau d'objets Article, avec un champ 'comment_count'
 */
public function getAllArticles(array $orderBy = []): array
{
    $sql = "
    ...
    if (!empty($orderBy)) {
        ...
        foreach ($orderBy as $column => $direction) {
            if (!empty($column) && !empty($direction)) {
                $clauses[] = $column . " " . strtoupper($direction);
            }
        }
